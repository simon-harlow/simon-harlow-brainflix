            ...
            <section className="upload">
                ...
                <form className="upload-form" id="upload-form" onSubmit={handleSubmit} >
                    <div className="upload-form__thumbnail-container">
                        ...
                        <img className="upload-form__thumbnail" src={VideoThumbnail} alt="bike handlebars" name="thumbnail" id="thumbnail"/>
                    </div>
                    ...
                    <div className="upload-form__button-container">
                        ...
                        <button className="upload-form__cancel-button" type="button" id="cancel">
                            <img className="upload-form__cancel-button-img" src={Publish} alt="publish icon" />
